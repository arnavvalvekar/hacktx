...
function x(e2) {
  if ("number" != typeof e2.modulusLength || e2.modulusLength < 2048)
    throw new R(`${e2.name} modulusLength must be at least 2048 bits`);
}
...
if (Uint8Array.prototype.toBase64)
  E = (e2) => (e2 instanceof ArrayBuffer && (e2 = new Uint8Array(e2)), e2.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e2 = 32768;
  E = (t2) => {
...
var re = (e2) => {
  ...
  if (e2.max_age && !oe(t2.claims.auth_time))
    throw new Error("Authentication Time (auth_time) claim must be a number present in the ID token when Max Age (max_age) is specified");
  if (null == t2.claims.exp || !oe(t2.claims.exp))
...
var Re = class {
  constructor(e2) {
    ...
    if (this.userCache = new ee().enclosedCache, this.defaultOptions = { authorizationParams: { scope: "openid profile email" }, useRefreshTokensFallback: false, useFormData: true }, this._releaseLockOnPageHide = async () => {
      ...
      if (t2 = e2.cacheLocation || "memory", !Ie(t2))
      ...
      if (!await (async (e2, t3 = 3) => {
        for (let n3 = 0; n3 < t3; n3++)
          if (await e2())
            return true;
        return false;
      })(() => Ne.acquireLock("auth0.lock.getTokenSilently", 5e3), 10))
        throw new l();
      try {
